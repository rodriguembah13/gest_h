...
class MenuBuilderSubscriber implements EventSubscriberInterface
{
    ...
    {
        $event->addItem(
            new MenuItemModel('home', 'menu.homepage', 'home', [], 'fas fa-tachometer-alt')
        );

        $event->addItem(
            new MenuItemModel('hotel', 'menu.form', 'hotel', [], 'fab fa-wpforms')
        );
...
*/
        ...
        $demo->addChild(
            new MenuItemModel('sub-demo', 'Form - Horizontal', 'hotel', [], 'far fa-arrow-alt-circle-down')
        )->addChild(
            new MenuItemModel('sub-demo2', 'Form - Sidebar', 'hotel', [], 'far fa-arrow-alt-circle-up')
        );
        $event->addItem($demo);
